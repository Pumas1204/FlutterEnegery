...
import { AppContextActionType, AppContextType, ProfileType } from "../types";
import { globalStateSetter } from "./actions";
import { globalContextInitialValue } from "./value";

const ContainerComp: React.FC<PropsWithChildren<{ profile?: ProfileType }>> = (
  props,
) => {
  ...
  const init = globalContextInitialValue(props.profile);
